...
$czcionka = New-Object System.Windows.Forms.FontDialog
$wybierzC = New-Object System.Windows.Forms.Button
$wybierzC.Location = New-Object System.Drawing.Size(400,200)
$wybierzC.Text = "Wybierz czcionke"
$wybierzC.Width = 200

$wybierzC.Add_Click({
$czcionka.ShowDialog()
$wynik.Font=$czcionka.Font
})

$okno.Controls.Add($wybierzC)
